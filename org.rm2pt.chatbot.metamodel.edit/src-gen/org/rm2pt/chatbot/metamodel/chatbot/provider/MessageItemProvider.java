...
/**
 * This is the item provider adapter for a {@link org.rm2pt.chatbot.metamodel.chatbot.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Message_content_feature",
								"_UI_Message_type"),
						ChatbotPackage.Literals.MESSAGE__CONTENT, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Message_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Message_type_feature", "_UI_Message_type"),
						ChatbotPackage.Literals.MESSAGE__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
