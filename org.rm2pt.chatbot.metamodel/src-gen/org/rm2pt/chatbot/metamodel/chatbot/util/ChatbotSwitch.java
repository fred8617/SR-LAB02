 ...
 * @generated
 */
public class ChatbotSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ChatbotPackage.USER: {
			User user = (User) theEObject;
			T result = caseUser(user);
			if (result == null)
				result = caseAdmin(user);
			if (result == null)
				result = caseNormalUser(user);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ChatbotPackage.NORMAL_USER: {
			NormalUser normalUser = (NormalUser) theEObject;
			T result = caseNormalUser(normalUser);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Normal User</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Normal User</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNormalUser(NormalUser object) {
		return null;
	}
