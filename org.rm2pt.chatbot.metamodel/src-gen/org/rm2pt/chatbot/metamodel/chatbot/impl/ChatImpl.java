 ...
 * </p>
 * <ul>
 *   <li>{@link org.rm2pt.chatbot.metamodel.chatbot.impl.ChatImpl#getMessage <em>Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChatImpl extends MinimalEObjectImpl.Container implements Chat {
	...
	protected EClass eStaticClass() {
		return ChatbotPackage.Literals.CHAT;
	}
	...
	public EList<Message> getMessage() {
		if (message == null) {
			message = new EObjectResolvingEList<Message>(Message.class, this, ChatbotPackage.CHAT__MESSAGE);
		}
		return message;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ChatbotPackage.CHAT__MESSAGE:
			return getMessage();
		}
